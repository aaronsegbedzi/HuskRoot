...
public class EditProduct extends AppCompatActivity implements OnMapReadyCallback, GoogleMap.OnMyLocationButtonClickListener, GoogleMap.OnMarkerDragListener {
    ...
    Button audioRecordStart, audioRecordStop, audioPlay, audioPause, btnVideo;
    ...
    Bundle bundle;
    Boolean stillRemoteSource;
    HashMap<Integer,String> spinnerMap;
    int SubSubCategorySelection;
...
//        SET STRING VALUES FOR SUBSUBCATEGORY SPINNER.
...
//        BEGIN VIDEO RECORDING FEATURE FOR PRODUCT VIDEO.
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                EditProduct.this.uploadMultipart(view);
            }
        });

        Button btnDelete = (Button)findViewById(R.id.btnReset);
        btnDelete.setText("Delete");
        btnDelete.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                DeleteProductWorker deleteProductWorker = new DeleteProductWorker(EditProduct.this);
                deleteProductWorker.execute(bundle.getString("product_id"));
            }
        });

    }

    protected void onPreDelete(MenuItem item){
        DeleteProductWorker deleteProductWorker = new DeleteProductWorker(EditProduct.this);
        deleteProductWorker.execute(bundle.getString("product_id"));
    }
            ...
            if (requestCode == CAMERA_REQUEST) {
                ...
                if (mediaController == null) {
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                        mediaController = new MediaController(EditProduct.this);
    ...
    public void uploadMultipart(View view) {
        ...
        if (!productName.matches("")
            ...
            pDialog = new ProgressDialog(EditProduct.this, ProgressDialog.THEME_DEVICE_DEFAULT_LIGHT);
            pDialog.setProgressStyle(ProgressDialog.STYLE_HORIZONTAL);
            pDialog.setTitle("Uploading Crop");
            pDialog.setMax(100);
            ...
            pDialog.show();
            try {
                MultipartUploadRequest multipartUploadRequest = new MultipartUploadRequest(this, Config.remoteHost + "/api/v2/product.php?id=" + bundle.getString("product_id") + "&update=true&token=" + access_key);
                if (AudioSavePathInDevice != null && !stillRemoteSource) {multipartUploadRequest.addFileToUpload(AudioSavePathInDevice, "audio");}
                ...
                Toast.makeText(EditProduct.this, exc.getMessage(), Toast.LENGTH_LONG).show();
            }
        }else {
            Snackbar snackbar = Snackbar.make(view, "Please fill all required fields.", Snackbar.LENGTH_SHORT)
    ...
    public void setProduct(final String product){
        try {
            ...
            getSupportActionBar().setTitle("Edit - " + jsonObject.getString("name"));
            ...
            SubSubCategorySelection = Integer.parseInt(jsonObject.getString("subsubCategoryid"));
            ...
            Glide.with(this).load(Config.remoteHost + "/assets/img/products/"
                    + jsonObject.getString("peopleid") + "/"
                    + jsonObject.getString("id") + ".jpg")
                    .thumbnail(0.1f)
                    .into(productImage);

            AudioSavePathInDevice = Config.remoteHost + "/assets/audio/products/" + jsonObject.getString("peopleid") + "/" + jsonObject.getString("id") + ".wav";
            stillRemoteSource = true;
            ...
            if (mediaController == null){
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                    ...
                    mediaController.setAnchorView(videoView);
                    videoView.setMediaController(mediaController);
                    videoView.setVideoPath(Config.remoteHost + "/assets/video/products/" + jsonObject.getString("peopleid") + "/" + jsonObject.getString("id") + ".mp4");
                    videoView.requestFocus();
                }
            }
    ...
    protected void setSubSubCategories(String[][] string){
        ...
        SubSubCategory.setSelection(SubSubCategorySelection - 1, true);
    }
